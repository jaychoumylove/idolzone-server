...
Route::rule('api/:version/page/my_achievement', 'api/v1.Page/myAchievement');//
...
Route::rule('api/:version/config/active_conform', 'api/v1.Ext/activeConform');// 圈子活动配置信息
...
Route::rule('api/:version/open/info', 'api/v1.Open/info');// 助力用户排名
...
Route::rule('api/:version/open/remove', 'api/v1.Open/remove');// 删除图片
...
Route::rule('api/:version/lucky/draw/exchange_more', 'api/v1.UserLuckyDraw/exchangeMore');// 20张抽奖券兑换幸运碎片和灵丹
