...
INSERT INTO `f_cfg_weal_activity_task`(`name`, `icon`, `desc`, `sort`, `done`, `limit_times`, `key`, `reward`, `type`, `btn_text`, `gopage`, `open_type`, `shareid`, `create_time`, `update_time`, `delete_time`, `status`) VALUES ('补充鲜花', 'https://mmbiz.qpic.cn/mmbiz_png/w5pLFvdua9FquzibbuL4TMQyMbRKaQyUhLBDFLSfEgnRuQZBDwBQHBqr9Y4tMicSDcDjzwWhC4Xh0z19SmBaX2rg/0', '每次补充等值数额鲜花', 6, 35, 0, 'RECHARGE', 0.10, 'SUM', '回复“1”', '/pages/charge/charge', 'contact', 0, '2020-07-20 09:37:16', '2020-07-21 11:19:35', NULL, 'ON');
